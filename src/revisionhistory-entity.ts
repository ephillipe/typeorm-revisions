...
export interface RevisionHistoryInterface {
  id: number | string;
  originalID: number | string;

  action: HistoryActionType;
}
export interface RevisionHistorySubscriberInterface<EntityType, HistoryEntityType>
...
export abstract class RevisionHistorySubscriber<EntityType, HistoryEntityType extends HistoryEntityInterface & EntityType>
